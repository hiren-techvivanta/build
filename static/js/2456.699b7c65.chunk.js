"use strict";(self.webpackChunkonewave=self.webpackChunkonewave||[]).push([[2456],{10477:(e,t,o)=>{o(61446)},23723:(e,t,o)=>{var i=o(37022),r=o(56370),a=o(39446),s=o(37845);const n=i.AH`
  :host {
    display: flex;
  }
...
`;var F=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"===typeof Reflect&&"function"===typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let Y=class extends i.WF{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return i.qy`
    ...
    `}templateIcon(){return this.loading?i.qy`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:"default"===this.iconType?i.qy`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:i.qy`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};Y.styles=[f.W5,K],F([(0,r.MZ)()],Y.prototype,"backgroundColor",void 0),F([(0,r.MZ)()],Y.prototype,"iconColor",void 0),F([(0,r.MZ)()],Y.prototype,"icon",void 0),F([(0,r.MZ)()],Y.prototype,"message",void 0),F([(0,r.MZ)()],Y.prototype,"loading",void 0),F([(0,r.MZ)()],Y.prototype,"iconType",void 0),Y=F([(0,v.E)("wui-snackbar")],Y);const X=i.AH`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var _=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"===typeof Reflect&&"function"===typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};const V={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}};let G=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=g.P.state.open,this.unsubscribe.push(g.P.subscribeKey("open",(e=>{this.open=e,this.onOpen()})))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach((e=>e()))}render(){const{message:e,variant:t,svg:o}=g.P.state,r=V[t],{icon:a,iconColor:s}=o??r??{};return i.qy`
      <wui-snackbar
        message=${e}
        ...
        .loading=${"loading"===t}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),g.P.state.autoClose&&(this.timeout=setTimeout((()=>g.P.hide()),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};G.styles=X,_([(0,r.wk)()],G.prototype,"open",void 0),G=_([(0,b.EM)("w3m-snackbar")],G);o(61747),o(12904);const J=i.AH`
  :host {
...
//# sourceMappingURL=2456.699b7c65.chunk.js.map